...
public:
	...
	*/
	...
	// BEGIN META SECTION - OpenXR Native Environment Depth
	virtual void OnBeginRenderingLate_RenderThread(XrSession InSession, FRHICommandListImmediate& RHICmdList)
	{
	}
...
// END META SECTION - OpenXR Native Passthrough threading improvement
	...
	/** return max requested pixel density for a render target creation **/
	virtual float GetMaxPixelDensity()
	{
		return 0.0f;
	}
	...
	// BEGIN META SECTION - OpenXR AppSpaceWarp
	virtual void AllocateRenderTargetTextures_RenderThread()
	{
	}

	virtual bool GetRecommendedVelocityTextureSize_RenderThread(FIntPoint& OutTextureSize)
	{
		return false;
	}

	virtual FXRSwapChainPtr GetVelocitySwapchain_RenderThread()
	{
		return nullptr;
	}

	virtual FXRSwapChainPtr GetVelocityDepthSwapchain_RenderThread()
	{
		return nullptr;
	}
	// END META SECTION - OpenXR AppSpaceWarp
	...
	virtual void ReCalcPose(FTransform& ) { }
