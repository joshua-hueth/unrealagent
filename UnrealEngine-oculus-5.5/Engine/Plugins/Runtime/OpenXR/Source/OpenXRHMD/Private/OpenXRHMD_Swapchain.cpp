...
XrSwapchain FOpenXRSwapchain::CreateSwapchain(XrSession InSession, uint32 PlatformFormat, uint32 SizeX, uint32 SizeY, uint32 ArraySize, uint32 NumMips, uint32 NumSamples, ETextureDimension Dimension, ETextureCreateFlags CreateFlags, void* Next /*= nullptr*/)
// END META SECTION - Add XR Cubemap Support
{
	...
	info.height = SizeY;
// BEGIN META SECTION - Add XR Cubemap Support
	info.faceCount = (Dimension == ETextureDimension::TextureCube) ? 6 : 1;
// END META SECTION - Add XR Cubemap Support
...
// BEGIN META SECTION - Add XR Cubemap Support
	XrSwapchain Swapchain = FOpenXRSwapchain::CreateSwapchain(InSession, ToPlatformFormat(Format), SizeX, SizeY, ArraySize, NumMips, NumSamples, Dimension, CreateFlags);
// END META SECTION - Add XR Cubemap Support
	if (!Swapchain)
	{
		return nullptr;
...
// BEGIN META SECTION - Add XR Cubemap Support
		...
		case ETextureDimension::Texture2D:
			TextureChain.Add(D3D11RHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(D3D11RHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(D3D11RHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags | TexCreate_TargetArraySlicesIndependently, ClearValueBinding, Image.texture));
			break;
		default:
			return nullptr;
		}
...
// BEGIN META SECTION - Add XR Cubemap Support
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::Texture2DArray:  
			TextureChain.Add(DynamicRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags, ClearValueBinding, Image.texture));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(DynamicRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, CreateFlags | TexCreate_TargetArraySlicesIndependently, ClearValueBinding, Image.texture));
		}
// END META SECTION - Add XR Cubemap Support
	}
	return CreateXRSwapChain<FOpenXRSwapchain>(MoveTemp(TextureChain), (FTextureRHIRef&)TextureChain[0], Swapchain);
...
// END META SECTION - Add XR Cubemap Support
{
	...
	OutActualFormat = Format;
// BEGIN META SECTION - Add XR Cubemap Support
	XrSwapchain Swapchain = FOpenXRSwapchain::CreateSwapchain(InSession, GPixelFormats[Format].PlatformFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, Dimension, CreateFlags);
// END META SECTION - Add XR Cubemap Support
	if (!Swapchain)
	{
		return nullptr;
...
// BEGIN META SECTION - Add XR Cubemap Support
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, NumMips, NumSamples, 1, ClearValueBinding, Image.image, CreateFlags));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(DynamicRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, 1, ClearValueBinding, Image.image, CreateFlags));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(DynamicRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SizeX, false, NumMips, 1, NumSamples, 1, ClearValueBinding, Image.image, CreateFlags));
			break;
		default:
			return nullptr;
		}
...
// BEGIN META SECTION - Add XR Cubemap Support
	XrSwapchain Swapchain = FOpenXRSwapchain::CreateSwapchain(InSession, GPixelFormats[Format].PlatformFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, Dimension, CreateFlags, Next);
// END META SECTION - Add XR Cubemap Support
	if (!Swapchain)
	{
		return nullptr;
...
// BEGIN META SECTION - Add XR Cubemap Support
	XrSwapchain Swapchain = FOpenXRSwapchain::CreateSwapchain(InSession, ViewFormatList[0], SizeX, SizeY, ArraySize, NumMips, NumSamples, Dimension, CreateFlags, Next);
// END META SECTION - Add XR Cubemap Support
	if (!Swapchain)
	{
		return nullptr;
...
// BEGIN META SECTION - Add XR Cubemap Support
		...
		{
		case ETextureDimension::Texture2D:
			TextureChain.Add(VulkanRHI->RHICreateTexture2DFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, NumMips, NumSamples, Image.image, CreateFlags, ClearValueBinding));
			break;
		case ETextureDimension::Texture2DArray:
			TextureChain.Add(VulkanRHI->RHICreateTexture2DArrayFromResource(GPixelFormats[Format].UnrealFormat, SizeX, SizeY, ArraySize, NumMips, NumSamples, Image.image, CreateFlags, ClearValueBinding));
			break;
		case ETextureDimension::TextureCube:
			TextureChain.Add(VulkanRHI->RHICreateTextureCubeFromResource(GPixelFormats[Format].UnrealFormat, SizeX, false, 1 , NumMips, Image.image, CreateFlags, ClearValueBinding));
			break;
		default:
			return nullptr;
		}
