...
// BEGIN META SECTION - Audio Output Fix
				OculusAudioInputDevice.TrimToNullTerminator();
// END META SECTION - Audio Output Fix
			}
...
bool FOpenXRHMDModule::InitInstance()
{
	...
	// BEGIN META SECTION - OpenXR header version
	// Use OpenXR 1.0 header version because Link doesn't support 1.1 at the moment
	Info.applicationInfo.apiVersion = XR_API_VERSION_1_0;
	// END META SECTION - OpenXR header version
