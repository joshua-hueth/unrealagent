...
struct FRHIGlobals
{
	...
	/** true if the RHI supports multi-view per view viewports */
	bool SupportsMultiViewPerViewViewports;
	...
	***/
	...
	struct FVariableRateShading
	{
		...
		FIntPoint ImageOffsetGranularity = FIntPoint::ZeroValue;
...
#define GSupportsMultiViewPerViewViewports                     GRHIGlobals.SupportsMultiViewPerViewViewports
...
#define GRHIVariableRateShadingImageOffsetGranularity          GRHIGlobals.VariableRateShading.ImageOffsetGranularity
