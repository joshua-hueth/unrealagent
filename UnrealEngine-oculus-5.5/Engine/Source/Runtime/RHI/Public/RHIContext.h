...
public:
	...
	*/
	...
	virtual void RHISetStereoScissor(float LeftMinX, float RightMinX, float LeftMinY, float RightMinY, float LeftMaxX, float RightMaxX, float LeftMaxY, float RightMaxY)
	{
		/* empty default implementation */
	}
