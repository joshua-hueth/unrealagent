...
struct FRHICommandSetStereoScissor;
...
// BEGIN META SECTION - Multi-View Per View Viewports / Render Areas
void FRHICommandSetStereoScissor::Execute(FRHICommandListBase& CmdList)
{
	RHISTAT(SetStereoScissor);
	INTERNAL_DECORATOR(RHISetStereoScissor)(LeftMinX, RightMinX, LeftMinY, RightMinY, LeftMaxX, RightMaxX, LeftMaxY, RightMaxY);
}
// END META SECTION - Multi-View Per View Viewports / Render Areas
