...
public:
	...
	virtual void RHISetStereoScissor(float LeftMinX, float RightMinX, float LeftMinY, float RightMinY, float LeftMaxX, float RightMaxX, float LeftMaxY, float RightMaxY) override final
	{
		RHIContext->RHISetStereoScissor(LeftMinX, RightMinX, LeftMinY, RightMinY, LeftMaxX, RightMaxX, LeftMaxY, RightMaxY);
	}
