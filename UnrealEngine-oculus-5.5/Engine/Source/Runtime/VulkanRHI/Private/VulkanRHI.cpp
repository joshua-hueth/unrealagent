...
int32 GVulkanEnableMultiviewPerViewRenderAreas = 0;
static FAutoConsoleVariableRef CVarVulkanEnableMultiviewPerViewRenderAreas(
	TEXT("r.Vulkan.EnableMultiviewPerViewRenderAreas"),
	GVulkanEnableMultiviewPerViewRenderAreas,
	TEXT("0 to disable multiview per view renderareas (default)")
	TEXT("1 to enable multiview per view renderareas"),
	ECVF_ReadOnly
);
	...
	, DrawingViewport(nullptr)
{
	...
	GVulkanUseEmulatedUBs = IsUsingEmulatedUniformBuffers(GMaxRHIShaderPlatform);
