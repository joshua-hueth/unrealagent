...
// BEGIN META SECTION - Emulated Uniform Buffers
	inline void SetUniformBufferConstantData(uint32 BindingIndex, TArrayView<const uint8> ConstantData)
	{
...
// BEGIN META SECTION - Emulated Uniform Buffers
	inline void SetUniformBufferConstantData(uint8 Stage, uint32 BindingIndex, TArrayView<const uint8> ConstantData)
	{
