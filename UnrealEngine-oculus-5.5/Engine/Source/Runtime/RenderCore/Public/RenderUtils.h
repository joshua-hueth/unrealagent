...
// Maximum number of mobile lights that can be bound to one draw in UniformLocalLights mode
#define MOBILE_FORWARD_UNIFORM_LOCAL_LIGHTS_MAX 8
// When specializing mobile lights, never specialize more than this many lights
#define MOBILE_FORWARD_UNIFORM_LOCAL_LIGHTS_UNROLLED_MAX 4
