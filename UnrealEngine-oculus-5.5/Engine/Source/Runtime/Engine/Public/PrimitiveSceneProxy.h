...
public:
	...
	*/
	...
	// Get renderthread safe render data used by AssetUserData
	virtual const TArray<FAssetUserRenderData*>* GetAssetUserRenderData() const { return nullptr; }
	virtual void GetLocalToWorldArray(TArray<FMatrix>& LocalToWorlds) const { LocalToWorlds.Add(LocalToWorld); }
