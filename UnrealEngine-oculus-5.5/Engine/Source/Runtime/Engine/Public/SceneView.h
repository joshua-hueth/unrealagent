...
#define VIEW_UNIFORM_BUFFER_MEMBER_TABLE \
	...
	VIEW_UNIFORM_BUFFER_MEMBER_PER_VIEW(FVector3f, PreViewTranslationEyeAdjustment) \
...
namespace InstancedViewParametersUtils
{
	...
	void ENGINE_API CopyIntoInstancedViewParameters(FInstancedViewUniformShaderParameters& InstancedViewParameters, const FViewUniformShaderParameters& ViewParameters, uint32 CopyViewId);
...
// BEGIN META SECTION - Scene Flag for Multiview Shaders
	/* Track if this view is using multiview shaders */
	UE_DEPRECATED(5.5, "Use Aspects.IsMobileMultiViewEnabled() instead.")
	bool bHasMobileMultiviewShaders;
...
public:
	...
	*/
	...
	/** Whether to render external velocity textures. */
	bool bRenderStereoVelocity = false;
