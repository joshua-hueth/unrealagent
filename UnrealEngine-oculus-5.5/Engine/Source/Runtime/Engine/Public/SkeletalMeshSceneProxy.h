...
public:
	...
	*/
	...
	virtual const TArray<FAssetUserRenderData*>* GetAssetUserRenderData() const override { return &AssetUserRenderDataArray; }
...
protected:
	...
	// BEGIN META SECTION - Software Occlusion
	TArray<FAssetUserRenderData*> AssetUserRenderDataArray;
	// END META SECTION - Software Occlusion
