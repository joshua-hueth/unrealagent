...
void URendererSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	...
	if (PropertyChangedEvent.Property)
	{
		...
		if (PropertyChangedEvent.GetPropertyName() == GET_MEMBER_NAME_CHECKED(URendererSettings, bMobileSupportGPUScene) && bMobileSupportGPUScene)
		{
			bVulkanUseEmulatedUBs = false;
			UpdateDependentPropertyInConfigFile(this, GET_MEMBER_NAME_CHECKED(URendererSettings, bVulkanUseEmulatedUBs));
		}
