	...
	) const
{
	...
	else
	{
		...
		const FDFRelativeViewMatrices InstancedViewMatrices = View->GetInstancedSceneView() ? FDFRelativeViewMatrices::Create(View->GetInstancedSceneView()->ViewMatrices) : ViewMatrices;
		const FDFRelativeViewMatrices FinalMatrices[2] = { ViewMatrices, InstancedViewMatrices };
		SetShaderParametersLegacyVS(RHICmdList, VertexShader, FinalMatrices);
