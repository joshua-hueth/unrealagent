	...
	TSetupFunction SetupFunction)
{
	...
	// BEGIN META SECTION - Multi-View Per View Viewports
	...
	{
		RHICmdList.SetStereoViewport(OutputRect.Min.X, OutputRect.Min.X, OutputRect.Min.Y, OutputRect.Min.Y, 0.0f, OutputRect.Max.X, OutputRect.Max.X, OutputRect.Max.Y, OutputRect.Max.Y, 1.0f);
		RHICmdList.SetStereoScissor(OutputRect.Min.X, OutputRect.Min.X, OutputRect.Min.Y, OutputRect.Min.Y, OutputRect.Max.X, OutputRect.Max.X, OutputRect.Max.Y, OutputRect.Max.Y);
	}
	// END META SECTION - Multi-View Per View Viewports
