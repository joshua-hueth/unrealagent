...
public:
	virtual void InitRHI(FRHICommandListBase& RHICmdList) override
	{
		...
		static uint32 MaxBatchedPrimitives = IConsoleManager::Get().FindTConsoleVariableDataInt(TEXT("r.OcclusionQueries.OccludedPrimitiveQueryBatchSize"))->GetValueOnAnyThread();
