...
#define IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LocalLightSetting, NumLocalLights, LocalLightSettingName) \
	typedef TMobileBasePassPS< LightMapPolicyType, LocalLightSetting, NumLocalLights, EMobileTranslucentColorTransmittanceMode::DEFAULT, false > TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName; \
	IMPLEMENT_MATERIAL_SHADER_TYPE(template<>, TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName, TEXT("/Engine/Private/MobileBasePassPixelShader.usf"), TEXT("Main"), SF_Pixel); \
	typedef TMobileBasePassPS< LightMapPolicyType, LocalLightSetting, NumLocalLights, EMobileTranslucentColorTransmittanceMode::SINGLE_SRC_BLENDING, false > TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##ThinTranslGrey; \
	IMPLEMENT_MATERIAL_SHADER_TYPE(template<>, TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##ThinTranslGrey, TEXT("/Engine/Private/MobileBasePassPixelShader.usf"), TEXT("Main"), SF_Pixel); \
	typedef TMobileBasePassPS< LightMapPolicyType, LocalLightSetting, NumLocalLights, EMobileTranslucentColorTransmittanceMode::DEFAULT, true > TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##XRSoftOcclusions; \
	IMPLEMENT_MATERIAL_SHADER_TYPE(template<>, TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##XRSoftOcclusions, TEXT("/Engine/Private/MobileBasePassPixelShader.usf"), TEXT("Main"), SF_Pixel); \
	typedef TMobileBasePassPS< LightMapPolicyType, LocalLightSetting, NumLocalLights, EMobileTranslucentColorTransmittanceMode::SINGLE_SRC_BLENDING, true > TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##ThinTranslGrey##XRSoftOcclusions; \
	IMPLEMENT_MATERIAL_SHADER_TYPE(template<>, TMobileBasePassPS##LightMapPolicyName##LocalLightSettingName##ThinTranslGrey##XRSoftOcclusions, TEXT("/Engine/Private/MobileBasePassPixelShader.usf"), TEXT("Main"), SF_Pixel);
...
#define IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName) \
	...
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_DISABLED, 0, LOCAL_LIGHTS_DISABLED) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, 0, LOCAL_LIGHTS_ENABLED) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, 1, LOCAL_LIGHTS_ENABLED_1) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, 2, LOCAL_LIGHTS_ENABLED_2) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, 3, LOCAL_LIGHTS_ENABLED_3) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, 4, LOCAL_LIGHTS_ENABLED_4) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_ENABLED, INT32_MAX, LOCAL_LIGHTS_ENABLED_LOOP) \
	IMPLEMENT_MOBILE_SHADING_BASEPASS_LIGHTMAPPED_PIXEL_SHADER_TYPE(LightMapPolicyType, LightMapPolicyName, LOCAL_LIGHTS_BUFFER, 0, LOCAL_LIGHTS_BUFFER)

static_assert(MOBILE_FORWARD_UNIFORM_LOCAL_LIGHTS_UNROLLED_MAX == 4, "The above permutations need to be updated for the new unrolling maximum");
...
TRDGUniformBufferRef<FForwardMovableLightData> CreateForwardMovableLightData(FRDGBuilder& GraphBuilder, const FViewInfo& View)
{
	FForwardMovableLightData* BasePassParameters = GraphBuilder.AllocParameters<FForwardMovableLightData>();
	*BasePassParameters = View.ForwardLightingResources.ForwardMovableLightData;
	return GraphBuilder.CreateUniformBuffer(BasePassParameters);
}
