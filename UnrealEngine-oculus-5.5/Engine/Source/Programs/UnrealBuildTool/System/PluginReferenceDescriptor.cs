...
namespace UnrealBuildTool
{
	...
	public class PluginReferenceDescriptor
	{
		...
		public static PluginReferenceDescriptor FromJsonObject(JsonObject RawObject)
		{
			...
			bool bMetaXRBranchEnabled = false;
			RawObject.TryGetBoolField("EnabledMetaXRBranch", out bMetaXRBranchEnabled);
			// END META SECTION 

			PluginReferenceDescriptor Descriptor = new PluginReferenceDescriptor(RawObject.GetStringField("Name"), null, RawObject.GetBoolField("Enabled") || bMetaXRBranchEnabled);
