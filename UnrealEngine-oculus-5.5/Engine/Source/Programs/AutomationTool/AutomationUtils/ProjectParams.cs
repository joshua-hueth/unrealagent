...
namespace AutomationTool
{
	...
	public class ProjectParams
	{
		...
		private void AutodetectSettings(bool bReset)
		{
			...
			if (ClientTargetPlatformTypes.Contains(UnrealTargetPlatform.Android)
				&& LoadedEngineConfigs.TryGetValue(UnrealTargetPlatform.Android, out ConfigHierarchy AndroidEngineConfigs))
			{
				AndroidEngineConfigs.GetBool("/Script/OculusXRHMD.OculusXRHMDRuntimeSettings", "bIterativeCookOnTheFly", out bool bIterativeCookOnTheFly);

				CookOnTheFly |= bIterativeCookOnTheFly;
				IterativeCooking |= bIterativeCookOnTheFly;
				IterativeDeploy |= bIterativeCookOnTheFly;
			}
